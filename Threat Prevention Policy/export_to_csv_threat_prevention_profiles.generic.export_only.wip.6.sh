...
export jsonvaluekeys=${jsonvaluekeys}', .["overrides"][0]["protection"], .["overrides"][0]["override"]["action"], .["overrides"][0]["override"]["track"], .["overrides"][0]["override"]["capture-packets"]'
export jsonvaluekeys=${jsonvaluekeys}', .["overrides"][1]["protection"], .["overrides"][1]["override"]["action"], .["overrides"][1]["override"]["track"], .["overrides"][1]["override"]["capture-packets"]'
