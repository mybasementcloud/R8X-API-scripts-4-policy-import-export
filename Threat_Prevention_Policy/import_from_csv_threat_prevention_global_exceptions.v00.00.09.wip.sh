...
#
# SCRIPT Rough Example for importing threat prevention global exceptions exported to CSV with the export script
#
#
...
#export exportexportfile=z.threat_rulebase.${layerfilename}.export.${localnamenow}.csv
