...
#export outfileprefix='z.threat-rule-exception-rulebase'
...
echo 'Generate Threat Prevention Global Exceptions Rulebase detailed export for reference'
echo

export outfileheader=${outfileprefix}.${jsonrootkeyvalue4file}.FOR_REFERENCE_ONLY.header.${outfileext}
...
export csvheader=${csvheader}', "name", "exception-number", "type"'
...
export csvheader=${csvheader}', "protection-or-site.0.name", "protection-or-site.0.type"'
export csvheader=${csvheader}', "protection-or-site.1.name", "protection-or-site.1.type"'
export csvheader=${csvheader}', "protection-or-site.2.name", "protection-or-site.2.type"'
export csvheader=${csvheader}', "protection-or-site.3.name", "protection-or-site.3.type"'
export csvheader=${csvheader}', "protection-or-site.4.name", "protection-or-site.4.type"'
export csvheader=${csvheader}', "protection-or-site.5.name", "protection-or-site.5.type"'
...
export csvheader=${csvheader}', "track.name", "action.name", "enabled", "comments"'
...
export jsonvaluekeys=${jsonvaluekeys}', .["name"], .["exception-number"], .["type"]'
...
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][0]["name"], .["protection-or-site"][0]["type"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][1]["name"], .["protection-or-site"][1]["type"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][2]["name"], .["protection-or-site"][2]["type"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][3]["name"], .["protection-or-site"][3]["type"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][4]["name"], .["protection-or-site"][4]["type"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][5]["name"], .["protection-or-site"][5]["type"]'
...
export jsonvaluekeys=${jsonvaluekeys}', .["track"]["name"], .["action"]["name"], .["enabled"], .["comments"]'
...
export outfile=${outfileprefix}.${jsonrootkeyvalue4file}.FOR_REFERENCE_ONLY.${localnamenow}.${outfileext}

cat ${outfileheader} > ${outfile} 

cat ${showfile} | ${JQ} -r '.rulebase[].rulebase[] | [ '"${jsonvaluekeys}"' ] | @csv ' >> ${outfile} 
...
export exportoutfileheader=${outfileprefix}.${jsonrootkeyvalue4file}.export.header.${outfileext}
...
export csvheader=${csvheader}', "protected-scope-negate"'
export csvheader=${csvheader}', "protection-or-site.0"'
export csvheader=${csvheader}', "protection-or-site.1"'
export csvheader=${csvheader}', "protection-or-site.2"'
export csvheader=${csvheader}', "protection-or-site.3"'
export csvheader=${csvheader}', "protection-or-site.4"'
export csvheader=${csvheader}', "protection-or-site.5"'
...
export csvheader=${csvheader}', "service-negate"'
export csvheader=${csvheader}', "track", "action", "enabled", "comments"'
...
export jsonvaluekeys=${jsonvaluekeys}', .["protected-scope-negate"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][0]["name"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][1]["name"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][2]["name"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][3]["name"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][4]["name"]'
export jsonvaluekeys=${jsonvaluekeys}', .["protection-or-site"][5]["name"]'
...
export exportoutfile=${outfileprefix}.${jsonrootkeyvalue4file}.export.${localnamenow}.${outfileext}

cat ${exportoutfileheader} > ${exportoutfile} 

cat ${showfile} | ${JQ} -r '.rulebase[].rulebase[] | [ '"${jsonvaluekeys}"' ] | @csv ' >> ${exportoutfile} 
